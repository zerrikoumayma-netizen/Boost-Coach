package com.example.decathlon_project;

import com.example.decathlon_project.model.*;
import com.example.decathlon_project.model.SportEvent.EventType;
import com.example.decathlon_project.repository.*;
    ...
    public void run(String... args) {
        ...
        productRepository.save(
            Product.builder()
                ...
                .imageUrl(
                    "https://contents.mediadecathlon.com/triban-rc500.jpg"
                )
                .stockByCity(
        ...
        eventRepository.save(
            SportEvent.builder()
                .title("Atelier Nutrition Sportive Decathlon Rabat")
                .type(EventType.WORKSHOP)
                .eventDate(LocalDate.of(2025, 6, 5))
                .city("Rabat")
                .description(
                    "Conférence animée par un nutritionniste partenaire Decathlon."
                )
                .build()
        );
